/**
 * Represents a hand of six dice in Farkle.
 */
public class Hand { 
    Die[] dice; 
    boolean[] inTheMeld; 
    ...
    /**
     * Rolls all dice that are not in the meld.
     */
    ...
    /**
     * Returns the quantity of each die value.
     */
    ...
    /**
     * Returns the die at the specified index.
     */
    ...
    /**
     * Checks whether a die is in the meld.
     */
    ...
    /**
     * Moves a die back into the hand.
     */
